...
#  WorkDir_DEFINITIONS  - Compile definitions needed for the release
...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 2.6.3)" )
endif()
...
# Set the compiler definitions variable:
set( WorkDir_DEFINITIONS "" )

# The base projects that this project was built on top of:
set( WorkDir_BASE_PROJECTS AnalysisBase;2.6.3 )
...
set( ATLAS_PLATFORM x86_64-slc6-gcc49-opt )

# Packages provided by the project:
set( WorkDir_PACKAGE_NAMES TrackAnalysis )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES TrackAnalysisPkg;TrackAnalysisPkgPrivate;PixelAnalysisLib;runPixelClusterAnalysis )
