# $Id: atlas_export_sanitizer.cmake.in 784359 2016-11-15 15:36:28Z krasznaa $
#
...
#
# This is a tweaked version of the script, for AnalysisBase.
#
...
foreach( _element ${_targetsContent} )
   ...
   # Make the directories pointing at AtlasExternals be relative paths:
   string( REGEX REPLACE
      "/[^ \"]*/AnalysisBaseExternals/[^/]+/InstallArea/([^/]+)"
      "\$ENV{WorkDir_DIR}/../../../../AnalysisBaseExternals/\$ENV{WorkDir_VERSION}/InstallArea/\\1"
      _newContent ${_newContent} )
