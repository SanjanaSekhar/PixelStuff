...
struct PixelClusterHists
{
  ...
  PixelClusterHists(const TString& n)
  {
    ...
    h_ToTVSLocalEtaIPl   =  new TH2D( name + "PixelsToTVSLocalEtaIPl", "ToT VS Eta Incidence IBL Planar; Phi Incidence [rad]; ToT; #Hits", 640, -1.6025, 1.597575,200, -0.5,199.5 ); 
    h_ToTVSLocalEtaI3D   =  new TH2D( name + "PixelsToTVSLocalEtaI3D", "ToT VS Eta Incidence IBL 3D; Phi Incidence [rad]; ToT; #Hits", 640, -1.6025, 1.597575,200, -0.5,199.5 ); 
    h_ToTVSLocalEtaBL   =  new TH2D( name + "PixelsToTVSLocalEtaBL", "ToT VS Eta Incidence BL; Phi Incidence [rad]; ToT; #Hits", 640, -1.6025, 1.597575,200, -0.5,199.5 ); 
    h_ToTVSLocalEtaL1   =  new TH2D( name + "PixelsToTVSLocalEtaL1", "ToT VS Eta Incidence L1; Phi Incidence [rad]; ToT; #Hits", 640, -1.6025, 1.597575,200, -0.5,199.5 ); 
    h_ToTVSLocalEtaL2   =  new TH2D( name + "PixelsToTVSLocalEtaL2", "ToT VS Eta Incidence L2; Phi Incidence [rad]; ToT; #Hits", 640, -1.6025, 1.597575,200, -0.5,199.5 ); 
